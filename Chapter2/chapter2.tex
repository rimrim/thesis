...
We then go into details and further use it as a framework in our specific
...
\subsection{Desirabtele properties}
...
\item[Security against a malicious client:] In this work, we aim at security
  ...
  \item[Multifactor Attack Game.] This model extends the above protocol and
    ...
    biometric impersonation model's advantage, which was bound by
    $q \times FAR$.
  \end{description}
