...
\item[Homomorphic Operations.] Finally, lattice-based cryptography allows us to
  perform operations infeasible before, namely, flexble computing on encrypted data. This
...
grows: in theoretical computer science, this problem has been shown to be NP-hard under randomized. In cryptography, SVP is not used as it is; instead, a variant of the
