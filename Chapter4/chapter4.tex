...
The proof of Theorem \ref{theo:server} can be obtained using a sequence of games
...
present such a sequence, as well as the relations among the games, in order to demonstrate first
 the type I security model proof.
