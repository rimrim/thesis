...
can cause the inner product operations to perform really fast; however, it does not
...
\item[NTT domain] Given \(\mathbf{\hat{a}}\), which is the evaluation of
  ...
  For ciphertexts that are the multiplications or additions of polynomials, mapping rotations can be achieved by performing each one of them and then performing
